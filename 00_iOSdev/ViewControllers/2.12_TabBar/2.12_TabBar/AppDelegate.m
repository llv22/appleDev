...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // desc - 2.12 UITabBarController page 162
    ...
    // desc - with Array of First/Second Navigation Controller
    NSArray *twoNavigationViewController = @[self.firstNavigationController, self.secondNavigationController];
//    NSArray *twoViewControllers = [[NSArray alloc]initWithObjects:self.firstViewController, self.secondViewController, nil];
    ...
    [self.tabBarController setViewControllers:twoNavigationViewController];
